...
const MainComponent = () => {
  return (
    <main className="flex w-[50%] h-full min-h-screen flex-col border-l-[0.5px] border-r-[0.5px] border-gray-600">
          ...
          <div className="border-t-[0.5px] border-b-[0.5px] flex items-stretch py-6 px-4 space-x-2 border-gray-600 relative">
            <div className="w-10 h-10 bg-slate-400 rounded-full flex-none"></div>
            <div className="flex flex-col w-full h-full">
                <input type="text" className="w-full h-full bg-transparent border-b-[0.5px] border-gray-600 p-4 outline-none border-none text-2xl placeholder:text-gray-600" placeholder="What's happening?"/>
                  ...
                  <div className="flex flex-col">
                    <div className="flex items-center w-full justify-between">
                      <div className="flex items-center space-x-1 w-full">
                        <div className="font-bold">Eli Derjabin</div>
                        <div className="text-gray-500">@derjabineli</div>
                    ...
                    <div className="text-white text-base">
                      Lorem ipsum, dolor sit amet consectetur adipisicing elit. Corrupti natus cupiditate, placeat dicta, architecto libero, ex sed totam ratione repellat odio assumenda accusamus ipsa commodi 
                    </div>
